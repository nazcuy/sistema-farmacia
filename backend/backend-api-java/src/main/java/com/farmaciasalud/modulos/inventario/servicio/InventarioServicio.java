...
public class InventarioServicio {
    ...
    /**
     * Lista todos los lotes con stock de un medicamento. Ordenados por fecha de
     * vencimiento (FEFO).
     */
    ...
    /**
     * Obtiene el stock total de un medicamento. Suma las cantidades de todos
     * los lotes.
     */
    @Transactional(readOnly = true)
    ...
    /**
     * Ingresa un nuevo lote al inventario. Crea el lote y registra el
    ...
    /**
     * Reduce stock de un lote para dispensación. Usa el método FEFO para elegir
     * lotes.
     */
    ...
    public List<MovimientoStock> obtenerHistorialLote(Long loteId) {
        return movimientoRepositorio.findByLoteIdOrderByFechaMovimientoDesc(loteId);
    }
